        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link   scrollto" href="#bayes">Teorema Bayes</a></li>
                ...
                <div class="row content">
                    <div class="col-lg-6">
                        ...
                        <p style="text-align: justify;">
                            Aplikasi "Perbandingan Metode Certainty Factor dan Teorema Bayes pada Identifikasi Minat dan
                            Bakat Berdasarkan Multiple Intelligence Berbasis Web" adalah suatu sistem yang dikembangkan
                            untuk membantu mengidentifikasi minat dan bakat seseorang berdasarkan teori Multiple
                            Intelligence menggunakan metode Certainty Factor (CF) dan Teorema Bayes.
                        </p>

                        <p style="text-align: justify;">
                            Dalam konteks ini, metode Certainty Factor dan Teorema Bayes digunakan sebagai algoritma
                            pemrosesan data untuk menganalisis informasi yang diberikan oleh pengguna aplikasi. Tujuan
                            utama aplikasi ini adalah memberikan rekomendasi tentang minat dan bakat individu
                            berdasarkan teori Multiple Intelligence yang dikemukakan oleh Howard Gardner.
                        </p>
                    </div>
                                ...
                                <li>
                                    ...
                                    <div id="accordion-list-1" class="collapse show" data-bs-parent=".accordion-list">
                                        <p style="text-align: justify;">
                                            ...
                                            adalah
                                            sebuah metode klasisfikasi yang berdasarkan pada teorema bayes dengan asumsi
                                            yang diamati adalah independen satu sama lain.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div id="accordion-list-2" class="collapse" data-bs-parent=".accordion-list">
                                        <p style="text-align: justify;">
                                            ...
                                            mesin karena sifatnya yang efisien, mudah di implementasikan dan memberikan
                                            kinerja yang baik dalam banyak kasus. Meskipun memiliki asumsi sederhana
                                            tentang indepedensi fitur,Teorema Bayes seringkali memberikan hasil yang
                                            cukup baik dalam banyak tugas klasifikasi.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div id="accordion-list-3" class="collapse" data-bs-parent=".accordion-list">
                                        <p style="text-align: justify;">
                                            ...
                                            memperhitungkan frekuensi kemunculan fitur-fitur dalam set data pelatihan
                                            tersebut. Kemudian, saat diberikan data baru, Teorema Bayes menghitung
                                            probabilitas kelas untuk data tersebut berdasarkan probabilitas yang
                                            dihitung sebelumnya dan memilih kelas dengan probabilitas terbesar sebagai
                                            hasil klasifikasi
                                        </p>
                                    </div>
                                </li>
