            ...
            <div class="container">
                ...
                <div class="row" data-aos="zoom-in">
                    ...
                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url() ?>assets/template/landing_page/assets/img/clients/client-1.png" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url() ?>assets/template/landing_page/assets/img/clients/client-2.png" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url() ?>assets/template/landing_page/assets/img/clients/client-3.png" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url() ?>assets/template/landing_page/assets/img/clients/client-4.png" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url() ?>assets/template/landing_page/assets/img/clients/client-5.png" class="img-fluid" alt="">
                    </div>

                    <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                        <img src="<?= base_url() ?>assets/template/landing_page/assets/img/clients/client-6.png" class="img-fluid" alt="">
                    </div>
        ...
        <section id="certainty" class="why-us section-bg">
            <div class="container-fluid" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("<?= base_url() ?>assets/template/landing_page/assets/img/why-us.png");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
                </div>
        ...
        <section id="bayes" class="why-us">
            <div class="container-fluid" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 align-items-stretch img" style='background-image: url("<?= base_url() ?>assets/template/landing_page/assets/img/why-us.png");' data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
